...
auto sdk::__timer::has_elapsed(double milliseconds, bool fist_kernel_system_time_return_true, bool update_old_kernel_system_time) -> bool
{
	...
	if ((this->elapsed_milliseconds = (double)((this->new_kernel_system_time = KERNEL_SYSTEM_TIME) - this->old_kernel_system_time) * .0001) >= milliseconds)
	{
...
{
	this->elapsed_milliseconds = (double)((this->new_kernel_system_time = KERNEL_SYSTEM_TIME) - this->old_kernel_system_time) * .0001;
	this->old_kernel_system_time = this->new_kernel_system_time;
