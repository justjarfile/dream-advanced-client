...
auto client::features::visual::player_esp_2d::run(client::mapper::__minecraft& minecraft) -> void
{
	if (!client::features::visual::player_esp_2d::enabled)
		return;
	...
	for (auto& player : world_players)
	{
		...
		if (!client::features::visual::player_esp_2d::draw_invisible_players && player.get_flag(5))
			continue;
		...
		client::features::visual::render_2d_bounding_box(
			...
			client::features::visual::player_esp_2d::outline_color,
			client::features::visual::player_esp_2d::line_color,
			client::features::visual::player_esp_2d::fill_color,
			client::features::visual::player_esp_2d::draw_corners,
			client::features::visual::player_esp_2d::draw_health,
			player_health,
			client::features::visual::player_esp_2d::draw_hurt_time,
			(client::features::visual::player_esp_2d::draw_hurt_time ? player.get_hurt_time() : 0)
		);
	}
}